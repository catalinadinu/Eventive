...
public class DashboardFurnizorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_furnizor);
        ...
        deconectare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentDeconectare = new Intent(DashboardFurnizorActivity.this, LoginActivity.class);
